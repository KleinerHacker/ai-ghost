...
/**
 * View model of [TitlePageDesignSettings].
 *
 * The three style properties [TitlePageDesignProperty] carries are handled by
 * [TitlePageDesignSettingsView] directly, through the public API of the embedded [StyleDataEditor]
 * instances; this model only owns [showAuthor], mirroring
 * [TitlePageDesignProperty.showAuthorProperty] with a plain bidirectional binding.
 */
class TitlePageDesignSettingsViewModel : ViewModel {
    ...
    // place.
    private var design: TitlePageDesignProperty? = null
     ...
     */
    fun bind(design: TitlePageDesignProperty) {
        release()
