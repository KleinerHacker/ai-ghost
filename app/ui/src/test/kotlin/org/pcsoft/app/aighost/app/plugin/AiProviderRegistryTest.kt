...
class AiProviderRegistryTest {
    ...
    private fun entry(id: String, pluginId: String = id) = RegisteredAiProvider(
        id = id,
    ...
    fun `register keeps the first entry on an id collision`() {
        val registry = AiProviderRegistry()
        val first = entry("stub", pluginId = "built-in-stub")
        val second = entry("stub", pluginId = "user-stub")
