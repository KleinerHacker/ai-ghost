...
/**
 * Developer tests for [EpilogPageDesignProperty].
 *
 * The property wraps the design settings of the epilog page and offers the three styles it carries -
 ...
 */
class EpilogPageDesignPropertyTest {

    /** Stands for the design carrying this page, the object a parent property writes into. */
    private class Holder(var page: EpilogPageDesign?)

    private lateinit var holder: Holder
    private lateinit var property: EpilogPageDesignProperty
    ...
    fun setUp() {
        ...
        parentEvents = 0
        property = EpilogPageDesignProperty()
    ...
    private fun newPage(): EpilogPageDesign = EpilogPageDesign(
        titleStyle = StyleData(
            font = FontData("Epilog Title Serif", 21, bold = true),
            textLineSpacing = 1.3,
            alignment = Alignment.CENTER
        ),
        titleAppendixStyle = StyleData(
            font = FontData("Epilog Appendix Serif", 14, italic = true),
            textLineSpacing = 1.2,
            alignment = Alignment.CENTER
        ),
        textStyle = StyleData(
    ...
    /**
     * Use case: the design dialog of the epilog is opened, so every style property and every field of
     * it answer with the values the wrapped object carries instead of a copy made earlier.
     */
    @Test
    fun readsEveryFieldFromTheModelObject() {
        assertEquals("Epilog Title Serif", property.titleStyleProperty.fontProperty.nameProperty.get())
    ...
    /**
     * Use case: the user picks another font family for the epilog heading, so the value reaches the
    ...
    /**
     * Use case: the user sets the lines of the epilog body text further apart, so the factor reaches
    ...
    fun exchangingTheModelObjectUpdatesEveryField() {
        ...
        property.set(
            EpilogPageDesign(
                titleStyle = StyleData(
                    font = FontData("Other Title", 24),
                    textLineSpacing = 2.1,
                    alignment = Alignment.LEFT
                ),
                titleAppendixStyle = StyleData(
                    font = FontData("Other Appendix", 17),
                    textLineSpacing = 2.2,
                    alignment = Alignment.LEFT
                ),
                textStyle = StyleData(
