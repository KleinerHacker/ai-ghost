...
// Only the property and binding system is needed here; javafx.base carries it without any UI toolkit.
javafx {
    version = "25.0.1"
...
dependencies {
    // The plain model types appear in the signatures of the observable wrappers, so they are part of the API.
