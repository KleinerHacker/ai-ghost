...
// The plugin API deliberately carries no dependencies beyond the Kotlin standard library, so a
// plugin author only has to put this single artefact on the compile classpath.
