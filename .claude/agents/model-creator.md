---
name: model-creator
description: Creates new model POJOs in lib/model together with their FX property models in lib/fx-model and all tests, based on the exploration results of the model-explore agent.
