...
* Ein erledigter Plan wird samt Statusdatei entfernt; erledigt sind IP-01, IP-02, IP-24 und IP-03.
...
| IP-25 | Renderer-Bibliotheksmodul | `FP-001-IP-25-RendererBibliotheksmodul.md` | - |
| IP-26 | Umzug von Schrift und Messung | `FP-001-IP-26-SchriftUndMessungUmzug.md` | IP-01, IP-25 |
...
* IP-25 - Renderer-Bibliotheksmodul (blockiert durch die JavaFX-Entscheidung)
